...
filter_links = fs.open('/srv/scripts/siege/casperlinks.txt', 'r').read().trim().split('\n');
...
casper.start(targetSite,function(){
	...
	casper.each(filter_links, function(self, filter_link, num) {
		...
		//fs.write('/srv/scripts/siege/filterLinks-sub-' + num + '.txt', results.join('\r\n'));
	});
})
...
//save links to json file
    fs.write('/srv/scripts/siege/filterLinks-sub.txt', results.join('\n'));
